...
| rha                   | 2x    | Linux | 4090 / 7950x | [rha](https://github.com/umzi2/RHA)                                                                                               | 2.99    | ~1.4     | 8.7gb    | 17gb        | trt10.8 (trtexec+mlrt) | yes, works        | 1     | 5         | 3         | 4         | fp32 op20 | -                  | static      | -             | RGBS      | trtexec --bf16 --onnx=rha_op20_clamp_127800_1080p.onnx --saveEngine=rha_op20_clamp_127800_1080p.engine --tacticSources=+CUDNN,-CUBLAS,-CUBLAS_LT --skipInference --useCudaGraph --noDataTransfers --builderOptimizationLevel=5 --infStreams=3                                                                                                                                                 | no image with fp16                                                                                         |
