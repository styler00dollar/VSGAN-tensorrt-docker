...
clip = RIFE(clip, multi = 2, scale = 1.0, fp16 = True, fastmode = False, ensemble = True, model_version = "rife41", psnr_dedup = False, psnr_value = 70, ssim_dedup = False, 
...
#frames_duplicated, frames_duplicating = return_frames(txt, psnr_value=50)
